...
export default function ArtikelPage() {
  ...
  const articles = [
    ...
    },
    {
       ...
       time: "7 Menit Baca",
       image: <FaBrain />,
       desc: "Cara bijak menggunakan media sosial agar terhindar dari rasa cemas berlebih."
    },
    {
       slug: 'pentingnya-sarapan-sebelum-kuliah',
       title: "Pentingnya Sarapan Sebelum Kuliah",
       tag: "Nutrisi",
       time: "3 Menit Baca",
       image: <FaAppleAlt />,
       desc: "Meningkatkan daya serap pembelajaran dengan energi yang cukup di pagi hari."
    }
  ];
  ...
  const filteredArticles = articles.filter(art => {
    ...
    const matchesTab = activeTab === 'Semua' || art.tag === activeTab;
    ...
    <>
      ...
      <main className="min-h-screen pb-32 pt-32 bg-background-app">
        <div className="px-8 max-w-[450px] mx-auto">
          ...
          {/* Featured Article - Only show when no search/filter or if it matches */}
          ...
          <div className="space-y-6">
             <div className="flex justify-between items-center px-2">
                <h2 className="text-[12px] font-black text-gray-900 uppercase tracking-widest">
                  {searchQuery ? `Hasil untuk "${searchQuery}"` : 'Artikel Terbaru'}
                </h2>
                {searchQuery && (
             ...
             {filteredArticles.length > 0 ? (
               ...
               <div className="py-20 text-center">
                 <p className="text-gray-400 text-[12px] font-bold uppercase tracking-widest">Artikel tidak ditemukan</p>
               </div>
             )}
          </div>
