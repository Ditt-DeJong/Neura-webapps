...
import { 
  ...
  FaBrain, FaRunning, FaStar, FaBookMedical, FaWeight, FaTint, 
  FaHeadSideVirus, FaCoffee, FaAppleAlt, FaUserMd, FaStethoscope, 
  ...
  return (
    <>
      ...
      <main className="bg-white">
          ...
          <div className="px-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={idx} className="bg-white p-6 rounded-4xl border border-gray-100 shadow-xs hover:shadow-2xl hover:border-transparent transition-all duration-300 group flex flex-col items-center text-center">
        ...
        {/* PROMO HIGHLIGHTS - DEFINITIVE FIX */}
            ...
            <div className="space-y-6">
              {[
                { 
                  ...
                  gradient: 'from-[#FF6B8B] to-[#fb7185]',
                ...
                <div key={i} className={`bg-linear-to-br ${promo.gradient} p-8 rounded-[2.5rem] text-white relative overflow-hidden shadow-2xl ${promo.shadow} group`}>
          ...
          <div className="px-6">
            ...
            <div className="space-y-4">
               {[
                 ...
                 <div key={i} className="flex items-center gap-5 p-5 rounded-4xl border border-gray-100 hover:bg-gray-50/80 transition-all group cursor-pointer active:shadow-inner">
        ...
        {/* MEDICAL EXCELLENCE - DEFINITIVE CONTRAST FIX */}
          ...
          <div className="px-6">
            <div className="bg-[#0f172a] p-10 pt-14 rounded-[3.5rem] text-center text-white relative overflow-hidden shadow-2xl border border-white/5 ring-1 ring-white/10">
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <h2 className="text-2xl font-black mb-5 tracking-tight text-white !opacity-100">Board of Medical Excellence</h2>
      ...
      {/* FOOTER - DEFINITIVE FIX WITH EXTRA SPACING */}
